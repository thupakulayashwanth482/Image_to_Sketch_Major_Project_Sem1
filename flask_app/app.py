...
def cartoonize_2(img):
    ...
    inverted_image = 255 - cartoonize_1(img)
...
def cartoonize_3(img):
    ...
    # return imout_gray
    inverted_blurred = 255 - cartoonize_5(img)
    pencil_sketch = cv2.divide(cartoonize_1(img),inverted_blurred,scale= 256.0)
...
def cartoonize_5(img):
    blurred_image = cv2.GaussianBlur(cartoonize_2(img), (21,21),0)
